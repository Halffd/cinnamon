  ...
  [_("Sound and Media"), "media", None, "xsi-multimedia-symbolic",
    ...
    [_("Universal Access"), "accessibility", None, "xsi-accessibility-symbolic", [],
        [
            ...
            [_("Toggle zoom on/off"), CINNAMON_SCHEMA, "magnifier-toggle-zoom"],
            [_("Toggle zoom mode"), MUFFIN_KEYBINDINGS_SCHEMA, "toggle-zoom-mode"],
            [_("Restore previous zoom level"), CINNAMON_SCHEMA, "magnifier-zoom-previous"],
            [_("Set zoom mode to fullscreen"), CINNAMON_SCHEMA, "magnifier-zoom-mode-fullscreen"],
            [_("Set zoom mode to lens"), CINNAMON_SCHEMA, "magnifier-zoom-mode-lens"],
            [_("Set zoom mode to top half"), CINNAMON_SCHEMA, "magnifier-zoom-mode-top-half"],
            [_("Set zoom mode to bottom half"), CINNAMON_SCHEMA, "magnifier-zoom-mode-bottom-half"],
            [_("Set zoom mode to left half"), CINNAMON_SCHEMA, "magnifier-zoom-mode-left-half"],
            [_("Set zoom mode to right half"), CINNAMON_SCHEMA, "magnifier-zoom-mode-right-half"],
            [_("Toggle zoom-on-titlebar scope"), CINNAMON_SCHEMA, "magnifier-zoom-on-titlebar"],
            [_("Toggle zoom-on-fullscreen mode"), CINNAMON_SCHEMA, "magnifier-zoom-on-fullscreen"],
            [_("Increase zoom step"), CINNAMON_SCHEMA, "magnifier-zoom-increase-step"],
            [_("Decrease zoom step"), CINNAMON_SCHEMA, "magnifier-zoom-decrease-step"],
            [_("Reset zoom step"), CINNAMON_SCHEMA, "magnifier-zoom-reset-step"],
